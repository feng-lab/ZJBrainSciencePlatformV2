...
from app.model.response import ListNotificationsResponse, SendNotificationResponse, MarkNotificationsAsReadResponse
...
@router.get("/api/getRecentUnreadNotifications", description="获取最近未读通知", response_model=ListNotificationsResponse)
...
@router.get("/api/getNotificationsByPage", description="分页获取未读通知", response_model=ListNotificationsResponse)
@custom_json_response
...
@router.post("/api/markNotificationsAsRead", description="批量将通知标记为已读", response_model=MarkNotificationsAsReadResponse)
