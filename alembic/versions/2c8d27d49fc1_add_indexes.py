...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_experiment_operator_experiment_id"), "experiment_operator", ["experiment_id"], unique=False
    )
    ...
    op.create_index(op.f("ix_paradigm_file_file_id"), "paradigm_file", ["file_id"], unique=False)
    op.create_index(op.f("ix_paradigm_file_paradigm_id"), "paradigm_file", ["paradigm_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_experiment_operator_experiment_id"), table_name="experiment_operator")
    # ### end Alembic commands ###
