...
def upgrade() -> None:
    ...
    op.create_table('experiment_assistant',
    ...
    op.create_index(op.f('ix_experiment_assistant_experiment_id'), 'experiment_assistant', ['experiment_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.create_table('experiment_operator',
    ...
    sa.Column('is_main_operator', mysql.TINYINT(display_width=1), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
    op.create_index('ix_experiment_operator_experiment_id', 'experiment_operator', ['experiment_id'], unique=False)
