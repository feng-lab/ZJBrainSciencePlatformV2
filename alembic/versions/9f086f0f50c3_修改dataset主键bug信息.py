...
Revision ID: 9f086f0f50c3
Revises: 8dc0f8fefc93
Create Date: 2024-03-11 16:09:16.084022
...
def upgrade() -> None:
    ...
    sa.Column('development_stage', sa.Text(), nullable=False, comment='发育时期'),
    ...
    sa.Column('date_update_year', sa.DateTime(), nullable=True, comment='数据更新年份'),
    sa.Column('file_count', sa.Float(), nullable=True, comment='文件数量'),
    sa.Column('file_total_size_gb', sa.Float(), nullable=True, comment='数据总量(GB)'),
    sa.Column('file_acquired_size_gb', sa.Float(), nullable=True, comment='以获取数据(GB)'),
    sa.Column('associated_diseases', sa.Text(), nullable=False, comment='相关疾病'),
    ...
    op.create_index(op.f('ix_Dataset_user_id'), 'Dataset', ['user_id'], unique=True)
